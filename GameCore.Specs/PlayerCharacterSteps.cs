...
namespace GameCore.Specs
{
    ...
    public class PlayerCharacterSteps
    {
        ...
        public void GivenIHaveTheFollowingAttributes(Table table)
        {
            ...
            _context.Player.DamageResistance = Convert.ToInt32(attributes.Resistance);
        }
        ...
        [Then(@"my weapon should be worth (.*)")]
        public void ThenMyWeaponShouldBeWorth(int value)
        {
        ...
        public void ThenTheAmuletPowerShouldNotBeReduced()
        {
            ...
            //get the starting magical power from When step
