...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Chat messages limited in length", Skip="Ignored")]
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Chat messages limited in length", null, new string[] {
                        "mytag"});
#line 8
...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Chat messages are not offensive", Skip="Ignored")]
        [Xunit.TraitAttribute("FeatureTitle", "InGameChat")]
